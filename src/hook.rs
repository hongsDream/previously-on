...
use crate::domain::{
    deterministic_id, ContinuationAdviceV1, CoverageStatus, EventEnvelopeV1, EventKind,
    GitSnapshotV1, TaskLifecycle, TaskV1, SCHEMA_VERSION_V1,
};
...
use tool_evidence::{
    ...
    normalize_test_command, normalize_tool_result, prompt_text,
};
